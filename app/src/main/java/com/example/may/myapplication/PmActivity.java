...
public class PmActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = db.query("Pm",null,null,null,null,null,null);
        if(cursor.moveToFirst()){
            do{
                ...
                Log.d("Mainactivity", "PM2.5浓度"+content);
        ...
        double pm = intent.getDoubleExtra("p",0);
        tv_1.setText(pm+" μg/m³");
        if(pm < 40){
            tv_2.setText("空气清新，可吸入微粒含量极低");
        }else if(pm < 80){
            tv_2.setText("空气浑浊，空气中弥漫着可吸入颗粒物");
        }else if(pm < 120){
            tv_2.setText("PM含量偏高");
        }else if(pm < 200){
            tv_2.setText("PM含量超高，请及时采取有效措施");
        }else {
            tv_2.setText("PM含量已达到危险值，请及时开窗通风，开启换气设施");
        }
