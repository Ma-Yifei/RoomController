    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                Log.d("Mainactivity", "光照度"+content);
        ...
        double ill = intent.getDoubleExtra("ill",0);
        tv_1.setText(ill+" lux");
        if(ill  < 50){
            tv_2.setText("光照度极低，爱护眼睛，打开照明");
        }else if(ill < 80){
            tv_2.setText("光照度偏低，请及时打开照明");
        }else if(ill < 200){
            tv_2.setText("室内光照度适宜");
        }else {
            tv_2.setText("光照度偏高！爱护环境，从关灯开始");
        }
